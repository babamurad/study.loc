<div class="p-6 max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <flux:heading size="xl" class="mt-2">Создать новый курс</flux:heading>
    </div>

    <form wire:submit="save" class="space-y-6">
        <flux:field>
            <flux:label>Название курса</flux:label>
            <flux:input wire:model.live="title" placeholder="Например: Основы HTML и CSS" />
            <flux:error name="title" />
        </flux:field>

        <flux:field>
            <flux:label>Слизняк (Slug)</flux:label>
            <flux:input wire:model="slug" placeholder="osnovy-html-i-css" />
        ...
        <flux:field>
            ...
            <flux:textarea wire:model="description" rows="5" placeholder="Краткое описание курса..." />
        ...
        <flux:field>
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <flux:description>Сделать курс видимым для студентов сразу после создания.</flux:description>
                </div>
        ...
        <div class="flex justify-end space-x-2">
            ...
            <flux:button type="submit" variant="primary">Создать курс</flux:button>
        </div>
    </form>
</div>
