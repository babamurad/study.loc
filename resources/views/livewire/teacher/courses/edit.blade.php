            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <flux:heading size="lg">Включить итоговую практику по курсу</flux:heading>
                    </div>
                </div>

                @if($practiceEnabled)
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <flux:input wire:model="practiceTitle" label="Название практики" placeholder="Например: Дипломный проект" />
