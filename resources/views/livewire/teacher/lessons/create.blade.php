<div class="p-6">
    <div class="mb-6">
        ...
        <flux:heading size="xl" level="1">Создание урока</flux:heading>
        <flux:subheading>Заполните форму для добавления нового урока</flux:subheading>
    </div>
    ...
    <flux:card>
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                ...
                <flux:checkbox wire:model="is_published" label="Опубликовать сразу" />
            </div>

            <div class="flex justify-end gap-4 border-t pt-6">
                <flux:button href="{{ route('teacher.lessons.index') }}" variant="ghost">Отмена</flux:button>
                <flux:button type="submit" variant="primary">Создать урок</flux:button>
            </div>
        </form>
    </flux:card>
</div>
