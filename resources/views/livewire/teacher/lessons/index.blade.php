    ...
    <div class="flex flex-wrap items-center gap-3 mb-6">
        ...
        <div class="ml-auto flex items-center gap-2">
            <flux:dropdown align="end">
                <flux:button variant="ghost" size="sm" icon="view-columns" class="text-zinc-500">Столбцы</flux:button>
                <flux:menu>
                    <flux:menu.checkbox wire:model.live="selectedColumns.course_id">Курс</flux:menu.checkbox>
                    <flux:menu.checkbox wire:model.live="selectedColumns.module_id">Модуль</flux:menu.checkbox>
                    <flux:menu.checkbox wire:model.live="selectedColumns.position">Позиция</flux:menu.checkbox>
                    <flux:menu.checkbox wire:model.live="selectedColumns.is_published">Статус</flux:menu.checkbox>
                </flux:menu>
            </flux:dropdown>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead class="bg-zinc-50/50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-700">
                    <tr>
                        <th wire:click="sortBy('title')" class="px-6 py-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200 cursor-pointer select-none group/th hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                        ...
                        @if($selectedColumns['course_id'] ?? false)
                            <th wire:click="sortBy('course_id')" class="px-6 py-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200 hidden sm:table-cell cursor-pointer select-none group/th hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                <div class="flex items-center gap-1">
                                    Курс
                        ...
                        @endif
                        @if($selectedColumns['module_id'] ?? false)
                            <th wire:click="sortBy('module_id')" class="px-6 py-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200 hidden lg:table-cell cursor-pointer select-none group/th hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                <div class="flex items-center gap-1">
                                    Модуль
                        ...
                        @endif
                        @if($selectedColumns['position'] ?? false)
                            <th wire:click="sortBy('position')" class="px-6 py-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200 cursor-pointer select-none group/th hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                <div class="flex items-center gap-1">
                                    Поз.
                        ...
                        @endif
                        @if($selectedColumns['is_published'] ?? false)
                            <th wire:click="sortBy('is_published')" class="px-6 py-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200 cursor-pointer select-none group/th hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                <div class="flex items-center gap-1">
                                    Статус
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ count(array_filter($selectedColumns)) + 2 }}" class="px-6 py-12 text-center">
