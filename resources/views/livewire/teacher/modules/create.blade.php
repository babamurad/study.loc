<div class="p-6 max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <flux:heading size="xl" class="mt-2">Создать новый модуль</flux:heading>
    </div>

    <form wire:submit="save" class="space-y-6">
        <flux:field>
            <flux:label>Название модуля</flux:label>
            <flux:input wire:model="title" placeholder="Например: Введение в HTML" />
            <flux:error name="title" />
        </flux:field>

        <flux:field>
            <flux:label>Курс</flux:label>
            <flux:select wire:model.live="course_id" placeholder="Выберите курс...">
        ...
        <div class="flex justify-end space-x-2">
            ...
            <flux:button type="submit" variant="primary">Создать модуль</flux:button>
        </div>
    </form>
</div>
